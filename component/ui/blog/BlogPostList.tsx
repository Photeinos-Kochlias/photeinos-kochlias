...
export function BlogPostList({ posts, currentUserId, onEdit, onDelete, onReact }: BlogPostListProps) {
    return (
                ...
                {posts.map((post) => (
                    ...
                    >
                        ...
                        <div className="mt-4 flex flex-wrap items-center gap-2 text-sm text-slate-600">
                            {post.authorUsername ? (
                                <Link href={`/profile/${post.authorUsername}`} className="text-sky-600 underline">
                                    {post.authorUsername}
                                </Link>
                            ) : null}
